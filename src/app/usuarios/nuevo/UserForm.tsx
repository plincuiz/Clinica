...
export default function UserForm({ roles, especialidades }: { roles: string[]; especialidades: Esp[] }) {
    ...
    <form onSubmit={onSubmit} className="bg-white rounded-lg shadow p-6 space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select name="role" required onChange={(e) => setRol(e.target.value)} className="mt-1 block w-full rounded-md border p-2">
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Guardar Usuario</button>
      </div>
    </form>
  )
}
